...
class CoinsViewModel(app: Application, private val repository: CoinMarketRepository) : AndroidViewModel(app) {
    ...
    fun getCoinInfo(id: String) = viewModelScope.launch(IO) {
        coinInfoCall(id)
    }
    ...
    private suspend fun lastDayCoinDetailsCall(id: String) {
        try {
            ...
            when(t) {
                is IOException -> _lastDayCoinDetails.postValue(Resource.Error(getApplication<CoinMarketApplication>().getString(R.string.network_failure)))
                else -> _lastDayCoinDetails.postValue(Resource.Error(getApplication<CoinMarketApplication>().getString(R.string.conversion_error)))
            }
        }
    }
    ...
    private suspend fun yearCoinDetailsCall(id: String) {
        try {
            ...
            when(t) {
                is IOException -> _yearCoinDetails.postValue(Resource.Error(getApplication<CoinMarketApplication>().getString(R.string.network_failure)))
                else -> _yearCoinDetails.postValue(Resource.Error(getApplication<CoinMarketApplication>().getString(R.string.conversion_error)))
            }
        }
    }
    ...
    private suspend fun coinInfoCall(id: String) {
        try {
            ...
            when(t) {
                is IOException -> _coinInfo.postValue(Resource.Error(getApplication<CoinMarketApplication>().getString(R.string.network_failure)))
                else -> _coinInfo.postValue(Resource.Error(getApplication<CoinMarketApplication>().getString(R.string.conversion_error)))
            }
        }
    }
}